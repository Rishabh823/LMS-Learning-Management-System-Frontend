...
const SingleSelect = React.forwardRef<HTMLDivElement, SimpleSelectProps>(
  (
    {
      options,
      value,
    ...
    return (
      <div ref={dropdownRef} className="relative w-full">
        ...
        >
          ...
          <svg
            className={`w-4 h-4 transition-transform text-slate-400 ${isOpen ? "rotate-180 text-sky-500" : ""
              }`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
                  ...
                  {filteredOptions.map((option) => {
                    ...
                    return (
                      <div
                        ...
                        className={`
                          px-3 py-2 cursor-pointer hover:bg-sky-50
